    ...
    def _rank_with_gemini(
        ...
        for batch in _chunks(articles, 8):
            ...
            prompt = (
                ...
                "those interests; penalize stories that are only tangentially related (e.g. generic commodity "
                "news with no link to AI/robotics when those are user interests). "
